...
mv amanitaMuscaria.jpg /home/$username/Pictures/wallpapers
...
nala install x11-xserver-utils picom bspwm sxhkd feh kitty fish lxpolkit yad rofi polybar wget pulseaudio pavucontrol -y
# Installing Other less important Programs
nala install tldr neofetch flameshot vim lxappearance lxappearance arandr lightdm -y
